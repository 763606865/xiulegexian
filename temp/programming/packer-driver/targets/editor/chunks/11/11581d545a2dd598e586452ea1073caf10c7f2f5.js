      ...
      _export("Taijihuan", Taijihuan = (_dec = ccclass('Taijihuan'), _dec(_class = class Taijihuan extends (_crd && Weapon === void 0 ? (_reportPossibleCrUseOfWeapon({
        ...
        weaponMove(deltaTime) {
          ...
          if (this._duration > this._fallDuration) {
            //上升
            let rate = (this._duration - this._fallDuration) / (this._rawDuration - this._fallDuration); // console.log("rate up", rate);
            ...
            if (rate > 1) rate = 1; // console.log("rate fall", rate);
...
//# sourceMappingURL=11581d545a2dd598e586452ea1073caf10c7f2f5.js.map