    ...
    execute: function () {
      ...
      _export("MonsterManager", MonsterManager = (_dec = ccclass('MonsterManager'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(JsonAsset), _dec5 = property(JsonAsset), _dec6 = property(Label), _dec7 = property(Prefab), _dec(_class = (_class2 = class MonsterManager extends Component {
        ...
        updateQuadtree() {
          ...
          for (let i = 0; i < this.node.children.length; i++) {
            ...
            for (const child of par.children) {
              let collider = child.getComponent(BoxCollider2D); // let wp = child.getWorldPosition();
        ...
        showMonsterTotal(interval) {
          this.schedule(() => {
            let monsterTotal = this.getMonsterTotal(); // console.log("monsterTotal", monsterTotal);
        ...
        createMonsterLeader(id, type) {
          ...
          let leader = (_crd && plm === void 0 ? (_reportPossibleCrUseOfplm({
            error: Error()
        ...
        */
        ...
        createMonsterByOutsideData(id, queue, initOffset = null) {
        ...
        getRandomInitPos() {
          let coefficient = 2; // let index = Math.random() * 4 | 0;
        ...
        removeSomeMonsters(total) {
          let all = this.getAllMonster(); // console.log("all",all);
        ...
        getMonsterDataById(id) {
          let flag = this._monsterProperties.hasOwnProperty(id); // console.log("this._monsterProperties",this._monsterProperties);
...
//# sourceMappingURL=6f8c0fdb890f115355639b31074bfa80e3dadb36.js.map