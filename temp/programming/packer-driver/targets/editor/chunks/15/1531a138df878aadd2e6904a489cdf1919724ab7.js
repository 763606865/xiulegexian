  ...
  return {
    ...
    execute: function () {
      ...
      _export("ShowLayer", ShowLayer = (_dec = ccclass('ShowLayer'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class ShowLayer extends Component {
        ...
        createDamageTex(node, damageValue, initPos = {
          x: 0,
          y: 50
        }, type = "normal") {
          ...
          let color = this.getColorConfigByDamage(damageValue);
          ...
          let wp = node.getWorldPosition(); // tex.setPosition(initPos.x, initPos.y);
...
//# sourceMappingURL=1531a138df878aadd2e6904a489cdf1919724ab7.js.map