  ...
  return {
    ...
    execute: function () {
      ...
      PoolManager = class PoolManager {
        ...
        getFromPool(string, isNotice = false) {
          let pool = this.pools[string];
          let prefab = this.prefabs[string]; // if (!pool && !prefab) return console.log("对象池或预制件不存在");
        ...
        putToPool(string, obj, isNotice = false) {
          let pool = this.pools[string];
...
//# sourceMappingURL=76a07b06bc109cb795566f768dba58dd00ec8b54.js.map