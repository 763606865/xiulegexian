    ...
    execute: function () {
      ...
      _export("default", KdTree = class KdTree {
        ...
        buildObstacleTree() {
          ...
          const num = (_crd && Simulator === void 0 ? (_reportPossibleCrUseOfSimulator({
            error: Error()
        ...
        buildObstacleTreeRecursive(obstacles) {
          ...
          for (let i = 0; i < obstacles.length; ++i) {
            ...
            for (let j = 0; j < obstacles.length; ++j) {
              ...
              let j1LeftOfI = (_crd && RVOMath === void 0 ? (_reportPossibleCrUseOfRVOMath({
                error: Error()
              }), RVOMath) : RVOMath).leftOf(obstacleI1.point_, obstacleI2.point_, obstacleJ1.point_);
              let j2LeftOfI = (_crd && RVOMath === void 0 ? (_reportPossibleCrUseOfRVOMath({
                error: Error()
              }), RVOMath) : RVOMath).leftOf(obstacleI1.point_, obstacleI2.point_, obstacleJ2.point_);
          ...
          let leftObstacles = new Array(minLeft);
          let rightObstacles = new Array(minRight);
          let leftCounter = 0;
          let rightCounter = 0;
          let i = optimalSplit;
          let obstacleI1 = obstacles[i];
          ...
          for (let j = 0; j < obstacles.length; ++j) {
            ...
            if (j1LeftOfI >= -(_crd && RVOMath === void 0 ? (_reportPossibleCrUseOfRVOMath({
              ...
              let t = (_crd && RVOMath === void 0 ? (_reportPossibleCrUseOfRVOMath({
                ...
                error: Error()
              }), Vector2) : Vector2).subtract(obstacleJ1.point_, obstacleI1.point_)) / (_crd && RVOMath === void 0 ? (_reportPossibleCrUseOfRVOMath({
                error: Error()
              }), RVOMath) : RVOMath).det((_crd && Vector2 === void 0 ? (_reportPossibleCrUseOfVector({
                error: Error()
              }), Vector2) : Vector2).subtract(obstacleI2.point_, obstacleI1.point_), (_crd && Vector2 === void 0 ? (_reportPossibleCrUseOfVector({
                error: Error()
              }), Vector2) : Vector2).subtract(obstacleJ1.point_, obstacleJ2.point_));
              let splitPoint = (_crd && Vector2 === void 0 ? (_reportPossibleCrUseOfVector({
                error: Error()
              }), Vector2) : Vector2).addition(obstacleJ1.point_, (_crd && Vector2 === void 0 ? (_reportPossibleCrUseOfVector({
                error: Error()
              }), Vector2) : Vector2).multiply2(t, (_crd && Vector2 === void 0 ? (_reportPossibleCrUseOfVector({
                error: Error()
              }), Vector2) : Vector2).subtract(obstacleJ2.point_, obstacleJ1.point_)));
        ...
        queryAgentTreeRecursive(agent, obserObj, node) {
          ...
          if (agentTree.end_ - agentTree.begin_ <= this.MAX_LEAF_SIZE) {
            ...
            let distSqRight_1 = (_crd && RVOMath === void 0 ? (_reportPossibleCrUseOfRVOMath({
              error: Error()
            }), RVOMath) : RVOMath).sqr(Math.max(0, treeNode.minX_ - agent.position_.x));
            let distSqRight_2 = (_crd && RVOMath === void 0 ? (_reportPossibleCrUseOfRVOMath({
              error: Error()
            }), RVOMath) : RVOMath).sqr(Math.max(0, agent.position_.x - treeNode.maxX_));
            let distSqRight_3 = (_crd && RVOMath === void 0 ? (_reportPossibleCrUseOfRVOMath({
              error: Error()
            }), RVOMath) : RVOMath).sqr(Math.max(0, treeNode.minY_ - agent.position_.y));
            let distSqRight_4 = (_crd && RVOMath === void 0 ? (_reportPossibleCrUseOfRVOMath({
              error: Error()
...
//# sourceMappingURL=0761e34fa6f2eb1372a155db0fd61e8775e3858a.js.map