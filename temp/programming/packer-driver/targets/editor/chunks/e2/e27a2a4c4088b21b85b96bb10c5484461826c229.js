    ...
    execute: function () {
      ...
      _export("HeroInfoLayer", HeroInfoLayer = (_dec = ccclass('HeroInfoLayer'), _dec2 = property([SpriteFrame]), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property([SpriteFrame]), _dec(_class = (_class2 = class HeroInfoLayer extends Component {
        ...
        initRewardConfig() {
          ...
          let allSD = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
        ...
        initHeroProperty() {
          for (let i = 0; i < this._config.length; i++) {
            ...
            let curLv = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
              error: Error()
            ...
            let sprite = prefab.getChildByName("icon").getComponent(Sprite); // let loadUrl = "images/icons/icon_" + str + "/spriteFrame";
            ...
            (_crd && glf === void 0 ? (_reportPossibleCrUseOfglf({
              error: Error()
            }), glf) : glf).createButton(this.node, prefab.getChildByName("icon"), "HeroInfoLayer", "onBtnBaseProperty", str);
            (_crd && glf === void 0 ? (_reportPossibleCrUseOfglf({
              error: Error()
            }), glf) : glf).createButton(this.node, upgrade, "HeroInfoLayer", "onBtnUpgrade", str);
        ...
        onBtnUpgrade(e, p) {
          ...
          if (itemName) {
            ...
            let pLv = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
              error: Error()
            }), em) : em).dispatch("usingHeroBasePropertyFun", "getHeroBasePropertyCurLv", p);
            let pValue = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
              error: Error()
        ...
        isCanUpgrade(pName) {
          ...
          let itemTotal = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
        ...
        getUpgradeDescription(pName) {
          ...
          let lvDetail = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
        ...
        updateStorageSpace() {
          ...
          for (const key in list) {
            ...
            this._itemPrefabArr.push(prefab); //创建按钮事件


            (_crd && glf === void 0 ? (_reportPossibleCrUseOfglf({
              error: Error()
            }), glf) : glf).createButton(this.node, prefab.getChildByName("itemBg"), "HeroInfoLayer", "onBtnItem", key);
          }
        } // 初始化物品等级
        ...
        onBtnConfirmSell() {
          ...
          let totalPrice = data.price * total; // console.log("卖出物品总数：" + total);
        ...
        openTreasureChest() {
          ...
          let ratioArr = this._rewardConfig[itemName + "Ratio"]; // console.log("rewardArr", rewardArr);
        ...
        switchEqu() {
          let data = this._curSelectItemData;
          let type = data.type2; // 卸下装备

          let curEquName = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
        ...
        takeEqu(type, data) {
          ...
          let sprite = find("heroInfoBg/" + type + "/sprite", this.node).getComponent(Sprite);
...
//# sourceMappingURL=e27a2a4c4088b21b85b96bb10c5484461826c229.js.map