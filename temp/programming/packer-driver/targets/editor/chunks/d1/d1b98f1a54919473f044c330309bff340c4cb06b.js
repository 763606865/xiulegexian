    ...
    execute: function () {
      ...
      _export("Weapon", Weapon = (_dec = ccclass('Weapon'), _dec(_class = class Weapon extends Component {
        ...
        initCurLvInfo() {
          ...
          if (this._duration !== 0) {
            let bonusDuration = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
              error: Error()
          ...
          if (this._moveSpeed !== 0) {
            let bonusMS = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
              error: Error()
          ...
          if (this._canAttackTimes !== 0) {
            let bonusATs = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
              error: Error()
        ...
        initCircleCollider(tag, changeR = 0) {
        ...
        changeDirByAimDir(offsetAngle = 0) {
          let dir = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
          ...
          ;
          let bevelLen = Math.sqrt(dir.x * dir.x + dir.y * dir.y); // let sin = Math.sin(dir.x / bevelLen);
        ...
        changeDirByMoveDir(offsetAngle = 0) {
          ...
          let sin = Math.abs(dir.y) / bevelLen;
          let asin = Math.asin(sin);
          let angle = asin / Math.PI * 180; // console.log("angle", angle);
        ...
        updateMonsterBlood(other) {
          ...
          let isCriticalHit = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
          ...
          let bonusBackDis = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
...
//# sourceMappingURL=d1b98f1a54919473f044c330309bff340c4cb06b.js.map