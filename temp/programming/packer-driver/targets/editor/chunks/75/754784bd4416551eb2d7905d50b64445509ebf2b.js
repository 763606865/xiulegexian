    ...
    execute: function () {
      ...
      _export("MonsterLeader", MonsterLeader = (_dec = ccclass('MonsterLeader'), _dec2 = property(Material), _dec3 = property(Material), _dec4 = property(Material), _dec5 = property(Material), _dec6 = property([Material]), _dec(_class = (_class2 = class MonsterLeader extends (_crd && Monster === void 0 ? (_reportPossibleCrUseOfMonster({
        ...
        createLeader(id, type) {
          ...
          let data = JSON.parse(JSON.stringify((_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
        ...
        setDefaultMaterialByType(type) {
          let material = this.leaderMaterial[type]; // let material = this["leaderMaterial"+type];
        ...
        initCollider() {
          ...
          let monsterSize = new Size(UIT.contentSize.x / 2, UIT.contentSize.y / 2); // let monsterSize = new Size(UIT.contentSize.x*2/3, UIT.contentSize.y*2/3);
...
//# sourceMappingURL=754784bd4416551eb2d7905d50b64445509ebf2b.js.map