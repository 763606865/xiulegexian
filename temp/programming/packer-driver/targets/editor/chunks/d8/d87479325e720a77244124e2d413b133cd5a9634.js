    ...
    execute: function () {
      ...
      _export("Boss9", Boss9 = (_dec = ccclass('Boss9'), _dec(_class = class Boss9 extends (_crd && Boss === void 0 ? (_reportPossibleCrUseOfBoss({
        ...
        createTipsPrefab() {
          ...
          let posArr = [[-200, 0], [200, 0], [0, -200], [0, 200], [-200, -200], [200, -200], [-200, 200], [200, 200]];
          ...
          for (const pos of posArr) {
            ...
            tips.active = true;
            let anim = tips.getComponent(Animation);
            anim.on("finished", () => {
              if (!anim) return;
              tips.destroy();
...
//# sourceMappingURL=d87479325e720a77244124e2d413b133cd5a9634.js.map