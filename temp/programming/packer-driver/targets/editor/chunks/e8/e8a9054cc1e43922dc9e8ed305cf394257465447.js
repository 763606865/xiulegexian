      ...
      _export("HeroBaseProperty", HeroBaseProperty = (_dec = ccclass('HeroBaseProperty'), _dec2 = property(JsonAsset), _dec3 = property(JsonAsset), _dec4 = property(JsonAsset), _dec5 = property(JsonAsset), _dec6 = property(JsonAsset), _dec7 = property(JsonAsset), _dec8 = property(JsonAsset), _dec(_class = (_class2 = class HeroBaseProperty extends Component {
        ...
        initSkillBookData() {
          ...
          all.forEach(element => {
            ...
            let name2 = element.name2; // this._skillBookList[id] = element;
        ...
        initEquData() {
          ...
          let all3 = this.equEffectListJson.json; // console.log("all1", all1);
        ...
        initBasePropertyLv() {
          let config = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
        ...
        getEquDataByName(nameString) {
          //获得品级
          let qIndex = nameString.indexOf("（"); // if (qIndex < 0) throw "name string is error,cur name string is " + nameString;

          if (qIndex < 0) return null;
          let qKey = nameString.slice(0, qIndex);
          let lKey = nameString.slice(2);
          let qValue = this._equQualityList[qKey];
          let lValue = this._equLevelList[lKey]; // console.log("qKey",qKey);
...
//# sourceMappingURL=e8a9054cc1e43922dc9e8ed305cf394257465447.js.map