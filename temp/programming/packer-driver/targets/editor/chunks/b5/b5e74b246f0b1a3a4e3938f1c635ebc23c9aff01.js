      ...
      _export("WX_GAME", WX_GAME = (_dec = ccclass('WX_GAME'), _dec(_class = class WX_GAME extends Component {
        ...
        */
        ...
        initRewardAdByPlayTimes() {
          ...
          let adUnitId = (_crd && ggConfig === void 0 ? (_reportPossibleCrUseOfggConfig({
            error: Error()
          ...
          this._videoAd.onClose(res => {
            ...
            if (res && res.isEnded || res === undefined) {
              ...
              let index = this.getIndexByPlayTimes();
              if (index !== this._curAdIndex) this.initRewardAdByPlayTimes(); // 正常播放结束，可以下发游戏奖励
...
//# sourceMappingURL=b5e74b246f0b1a3a4e3938f1c635ebc23c9aff01.js.map