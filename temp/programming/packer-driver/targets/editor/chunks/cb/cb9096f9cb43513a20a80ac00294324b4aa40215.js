    ...
    execute: function () {
      ...
      _export("SkillManager", SkillManager = (_dec = ccclass('SkillManager'), _dec2 = property(Prefab), _dec(_class = (_class2 = class SkillManager extends Component {
            ...
            if (Object.prototype.hasOwnProperty.call(list, type)) {
              ...
              if (skillName) {
                ...
                (_crd && glf === void 0 ? (_reportPossibleCrUseOfglf({
                  error: Error()
                }), glf) : glf).createButton(this.node, skill, "SkillManager", "onBtnSkill", skillName);
              }
            }
          }
        } // 通用方法
        ...
        onBtnSkill(e, p) {
          ...
          this[p]();
          sprite.fillRange = 1;
          let totalTime = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
        ...
        startCoolDowntime(sprite, label, totalTime) {
          let interval = 1 / 60; // let interval = 1;
        ...
        godWindCloudBody() {
          ...
          this.schedule(() => {
            let times = Math.ceil((_crd && em === void 0 ? (_reportPossibleCrUseOfem({
              error: Error()
        ...
        getMoveSpeedFromSecretSkill() {
          let d1 = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
        ...
        getBackDisFromSecretSkill() {
          ...
          if (this._openSecretList.indexOf("driveWind") > -1) {
            let dwd = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
              error: Error()
...
//# sourceMappingURL=cb9096f9cb43513a20a80ac00294324b4aa40215.js.map