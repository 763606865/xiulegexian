    ...
    execute: function () {
      ...
      _export("Boss", Boss = (_dec = ccclass('Boss'), _dec(_class = class Boss extends Component {
        ...
        */
        ...
        isToSprintHero(offsetDis = 0, endCb = null, ingCb = null, ingGap = 1) {
          if (!this._canMove) return;
          let targetPos = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
          }), em) : em).dispatch("getHeroWorldPos");
        ...
        */
        ...
        startSprint(prefab, endCb = null, ingCb = null, ingGap) {
          let interval = 1 / 60;
        ...
        updateBlood(changeValue, isRepelled = false) {
        ...
        usingNormalParticleOneShot(scale = 1) {
          ...
          let np = (_crd && plm === void 0 ? (_reportPossibleCrUseOfplm({
            error: Error()
        ...
        usingNormalParticleTriangle(scale = 1) {
          let row = 5;
          let triPosArr = (_crd && glf === void 0 ? (_reportPossibleCrUseOfglf({
            error: Error()
          ...
          for (let i = triPosArr.length - 1; i >= 0; i--) {
            ...
            for (let j = 0; j < initPosArr.length; j++) {
              ...
              let dp = (_crd && plm === void 0 ? (_reportPossibleCrUseOfplm({
                error: Error()
              }), plm) : plm).getFromPool("normalParticle");
              dp.active = true;
        ...
        usingNormalParticleCircle(total, r, scale = 1) {
...
//# sourceMappingURL=95ec3d86d5b376610cbdb53b24f7278480f11515.js.map