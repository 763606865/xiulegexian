  ...
  return {
    ...
    execute: function () {
      ...
      _export("Boss15", Boss15 = (_dec = ccclass('Boss15'), _dec(_class = class Boss15 extends (_crd && Boss === void 0 ? (_reportPossibleCrUseOfBoss({
        ...
        usingDarkMask() {
          let dm = instantiate(this._darkMaskPrefab);
        ...
        usingBlackHole() {
          let bh = (_crd && plm === void 0 ? (_reportPossibleCrUseOfplm({
            error: Error()
...
//# sourceMappingURL=ba6840168e0975209059980464ef6d2731f17b75.js.map