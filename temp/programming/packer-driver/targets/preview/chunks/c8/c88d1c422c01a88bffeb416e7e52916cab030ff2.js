    ...
    execute: function () {
      ...
      _export("PreLoad", PreLoad = (_dec = ccclass('PreLoad'), _dec2 = property(Sprite), _dec3 = property(Label), _dec4 = property(Label), _dec(_class = (_class2 = class PreLoad extends Component {
        ...
        showLoginLayer() {
          ...
          var data = sys.localStorage.getItem("loginInfo");
        ...
        onBtnLogin() {
          ...
          var cb = this.loginComplete.bind(this);
          var eb = this.loginError.bind(this);
          var tb = this.loginTimeout.bind(this);
        ...
        onBtnRegister() {
          ...
          var cb = this.registerComplete.bind(this);
          var eb = this.registerComplete.bind(this);
          var tb = this.registerTimeout.bind(this);
          (_crd && hr === void 0 ? (_reportPossibleCrUseOfhr({
            error: Error()
          }), hr) : hr).post(url, data, cb, eb, tb);
...
//# sourceMappingURL=c88d1c422c01a88bffeb416e7e52916cab030ff2.js.map