System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, em, Boss, _dec, _class, _crd, ccclass, property, Boss42;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "9da67ASZMxPaafWwKlt+T8e", "Boss42", undefined);
      /*
      ...
      _export("Boss42", Boss42 = (_dec = ccclass('Boss42'), _dec(_class = class Boss42 extends (_crd && Boss === void 0 ? (_reportPossibleCrUseOfBoss({
        error: Error()
      }), Boss) : Boss) {
        constructor() {
          super(...arguments);
        ...
        onLoad() {
          var bossData = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
          }), em) : em).dispatch("usingHeroBasePropertyFun", "getBossDataById", 42);
...
//# sourceMappingURL=84bf4d271da3d03726ab19e372aff07279767770.js.map