System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("glf", glf = {
        //创建组件提供的按钮 或 修改内部调用 
        createButton: function createButton(scriptNode, buttonNode, scriptName, callbackName, param) {
          if (param === void 0) {
            param = '';
          }

          var flag = scriptNode && buttonNode && scriptName && callbackName; // console.log("scriptNode", scriptNode);
          ...
          var buttonHandler = new EventHandler();
        ...
        getTimeDetail() {
          ...
          var getTimeData = function getTimeData(time) {
...
//# sourceMappingURL=069e2694dfc711e6caf4663bc548c3498baf149e.js.map