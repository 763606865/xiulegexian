      ...
      _export("Monster", Monster = (_dec = ccclass('Monster'), _dec2 = property(Material), _dec3 = property(Material), _dec4 = property(Material), _dec5 = property(Material), _dec6 = property(Material), _dec7 = property(Material), _dec8 = property(Material), _dec9 = property(Material), _dec10 = property(AnimationClip), _dec(_class = (_class2 = class Monster extends Component {
        ...
        runOthers() {
          ...
          if ((_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            ...
            //地形减速
            var baseDamage = this._maxBlood * 0.05 | 0;
        ...
        initMonsterMoveAnim(data) {
          var animKey = "monster" + data.animKey;
          var clip = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
        ...
        updateBlood(changeValue, backDis) {
          if (backDis === void 0) {
            backDis = 0;
          }
          ...
          if (this._curBlood <= 0) {
            ...
            var debuffList = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
              error: Error()
        ...
        afterMonsterDied() {
          ...
          var value = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
        ...
        isTouchingHero() {
          var collider1 = this.getComponent(BoxCollider2D);
          var collider2 = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
        ...
        monsterAttackByCollide(self, other, type) {
          if (type === void 0) {
            type = "hero";
          }
        ...
        move() {
          if (this._sid > -1) {
            var pos = (_crd && Simulator === void 0 ? (_reportPossibleCrUseOfSimulator({
              error: Error()
        ...
        updatePrefVelocity() {
          ...
          if (targetPos != null) {
            var curPos = (_crd && Simulator === void 0 ? (_reportPossibleCrUseOfSimulator({
              error: Error()
            }), Simulator) : Simulator).Instance.getAgentPosition(this._sid);
            var goalVector = (_crd && Vector2 === void 0 ? (_reportPossibleCrUseOfVector({
              error: Error()
            ...
            if ((_crd && RVOMath === void 0 ? (_reportPossibleCrUseOfRVOMath({
              ...
              var tempV2 = (_crd && RVOMath === void 0 ? (_reportPossibleCrUseOfRVOMath({
                error: Error()
              }), RVOMath) : RVOMath).normalize(goalVector); // goalVector = Vector2.multiply2(10,tempV2);

              var times = this.getMonsterCurMoveSpeed() / 100;
        ...
        getMonsterCurDamage() {
          ...
          var damage = this._curMonsterData.damage; //胆怯
        ...
        getMonsterCurMoveSpeed() {
          ...
          if (this.isStrongControlled()) return 0;
          var moveSpeed = this._curMonsterData.moveSpeed * (_crd && monsterData === void 0 ? (_reportPossibleCrUseOfmonsterData({
            error: Error()
          ...
          if ((_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            ...
            //地形减速
            var slowTimes = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
              error: Error()
        ...
        setMonsterStrategyByIdOnTheBegging() {
          for (var id of this._curMonsterData.effects) {
            switch (id) {
              case 1:
        ...
        setBulletMonsterStrategy() {
          var probability = Math.ceil(this._monsterId / 6);
        ...
        setSpeedMonsterStrategy() {
          // 设置移速怪
          var times = Math.ceil(this._monsterId / 6) * 0.5 + 1.5;
        ...
        shotOnce(color) {
          var bullet = (_crd && plm === void 0 ? (_reportPossibleCrUseOfplm({
            error: Error()
...
//# sourceMappingURL=92ac07d227a24a766d13164584c628b7d591e4a6.js.map