    ...
    execute: function () {
      ...
      _export("PassRewardLayer", PassRewardLayer = (_dec = ccclass('PassRewardLayer'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Node), _dec(_class = (_class2 = class PassRewardLayer extends Component {
        ...
        showKillLeaderReward(strengthType) {
          ...
          var result = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
        ...
        showPassReward(all, string, isDouble) {
          if (isDouble === void 0) {
            isDouble = false;
          }
          ...
          all.forEach(data => {
            ...
            if (data.total > 0) {
              var prefab = instantiate(this._prefab);
              var itemData = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
                error: Error()
              ...
              var loadUrl = "images/items/" + itemData.loadUrl + "/spriteFrame";
              (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
                error: Error()
...
//# sourceMappingURL=358d72f2331ba1cf41bdec800c1804e68cd12cdb.js.map