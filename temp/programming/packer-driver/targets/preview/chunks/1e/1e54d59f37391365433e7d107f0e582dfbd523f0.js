    ...
    execute: function () {
      ...
      _export("default", Simulator = class Simulator {
        ...
        doStep() {
          ...
          for (var i = 0, j = this.agents_.length; i < j; i++) {
            var agent = this.agents_[i];
            agent.computeNeighbors();
            agent.computeNewVelocity();
          }

          for (var _i = 0, _j = this.agents_.length; _i < _j; _i++) {
            var _agent = this.agents_[_i];
        ...
        updateDeleteAgent() {
          ...
          for (var i = this.agents_.length - 1; i >= 0; i--) {
        ...
        onDelAgent() {
          ...
          for (var i = 0; i < this.agents_.length; i++) {
            var agentNo = this.agents_[i].id_;
        ...
        onAddAgent() {
          ...
          var index = this.agents_.length - 1;
          var agentNo = this.agents_[index].id_;
          this.agentNo2indexDict_.set(agentNo, index);
          this.index2agentNoDict_.set(index, agentNo);
        }

        getAgentPosition(agentNo) {
          var agent = this.agents_[this.agentNo2indexDict_.get(agentNo)];
...
//# sourceMappingURL=1e54d59f37391365433e7d107f0e582dfbd523f0.js.map