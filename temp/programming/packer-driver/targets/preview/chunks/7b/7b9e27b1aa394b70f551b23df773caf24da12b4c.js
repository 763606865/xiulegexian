    ...
    execute: function () {
      ...
      _export("Boss5", Boss5 = (_dec = ccclass('Boss5'), _dec2 = property(Prefab), _dec(_class = (_class2 = class Boss5 extends (_crd && Boss === void 0 ? (_reportPossibleCrUseOfBoss({
        ...
        usingSkillGreenThunder() {
          var gt = (_crd && plm === void 0 ? (_reportPossibleCrUseOfplm({
            error: Error()
        ...
        usingNormalAttack() {
          ...
          var bwp = this.node.getWorldPosition();
          var x = hwp.x - bwp.x;
          var y = hwp.y - bwp.y;
          var unitDis = 50;
          var angle = 0;
          ...
          var attack = this.node.getChildByName("attack");
          attack.angle = angle;
          attack.setPosition(offset.x, offset.y);
          attack.setScale(1, xScale);
          var anim = attack.getComponent(Animation);
          anim.play();
        } //一直释放闪电
        ...
        isUsingSkillPhotosynthesis() {
          var percentage = this.getBloodPercentage();
...
//# sourceMappingURL=7b9e27b1aa394b70f551b23df773caf24da12b4c.js.map