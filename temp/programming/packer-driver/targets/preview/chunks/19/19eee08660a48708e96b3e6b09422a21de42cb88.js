System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, em, Boss, _dec, _class, _crd, ccclass, property, Boss44;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "dcc57+wOSZJqLwluJl+GTRz", "Boss44", undefined);
      /*
      ...
      _export("Boss44", Boss44 = (_dec = ccclass('Boss44'), _dec(_class = class Boss44 extends (_crd && Boss === void 0 ? (_reportPossibleCrUseOfBoss({
        error: Error()
      }), Boss) : Boss) {
        constructor() {
          super(...arguments);
        ...
        onLoad() {
          var bossData = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
          }), em) : em).dispatch("usingHeroBasePropertyFun", "getBossDataById", 44);
...
//# sourceMappingURL=19eee08660a48708e96b3e6b09422a21de42cb88.js.map