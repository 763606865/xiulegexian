    ...
    execute: function () {
      ...
      _export("HeroCollider", HeroCollider = (_dec = ccclass('HeroCollider'), _dec(_class = class HeroCollider extends Component {
        ...
        openCollider() {
          ...
          var monsterSize = new Size(UIT.contentSize.x / 2, UIT.contentSize.y);
        ...
        onBeginContact(self, other) {
          switch (other.tag) {
            ...
            default:
              var ignore = [(_crd && tagData === void 0 ? (_reportPossibleCrUseOftagData({
                error: Error()
...
//# sourceMappingURL=64d5dfa248de9b5c3f4059956f12cd992c79d2e4.js.map