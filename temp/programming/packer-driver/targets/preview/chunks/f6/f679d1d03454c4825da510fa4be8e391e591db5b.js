System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, em, Boss, _dec, _class, _crd, ccclass, property, Boss40;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "ead3at/OO9PAbDAsRyG4sxI", "Boss40", undefined);
      /*
      ...
      _export("Boss40", Boss40 = (_dec = ccclass('Boss40'), _dec(_class = class Boss40 extends (_crd && Boss === void 0 ? (_reportPossibleCrUseOfBoss({
        error: Error()
      }), Boss) : Boss) {
        constructor() {
          super(...arguments);
        ...
        onLoad() {
          var bossData = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
          }), em) : em).dispatch("usingHeroBasePropertyFun", "getBossDataById", 40);
...
//# sourceMappingURL=f679d1d03454c4825da510fa4be8e391e591db5b.js.map