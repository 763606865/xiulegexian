    ...
    execute: function () {
      ...
      _export("Thundercloud", Thundercloud = (_dec = ccclass('Thundercloud'), _dec(_class = class Thundercloud extends (_crd && Weapon === void 0 ? (_reportPossibleCrUseOfWeapon({
        ...
        weaponMove(dt) {
          ...
          var time = this._moveSpeed == 0 ? 0 : dis / this._moveSpeed;
          var moveDisX = time == 0 ? 0 : dt / time * x;
          var moveDisY = time == 0 ? 0 : dt / time * y;
...
//# sourceMappingURL=c7f408700a12e8aa80bd194538c9bfd067e8e314.js.map