  ...
  return {
    ...
    execute: function () {
      ...
      _export("AddItemsLayer", AddItemsLayer = (_dec = ccclass('AddItemsLayer'), _dec(_class = class AddItemsLayer extends Component {
        ...
        onBtnConfirm() {
          var num = parseInt(this._curSelectTotal);
          ...
          ;
          var isValid = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
...
//# sourceMappingURL=f4650d314e60f420ab089eccb3ca44af3fd32a56.js.map