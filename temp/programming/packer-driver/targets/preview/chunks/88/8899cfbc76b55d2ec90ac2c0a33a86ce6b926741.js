    ...
    execute: function () {
      ...
      _export("SelectCheckpointLayer", SelectCheckpointLayer = (_dec = ccclass('SelectStageLayer'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(JsonAsset), _dec5 = property(JsonAsset), _dec6 = property(JsonAsset), _dec7 = property(Material), _dec8 = property(Material), _dec9 = property(Node), _dec(_class = (_class2 = class SelectCheckpointLayer extends Component {
        ...
        onEnable() {
          ...
          //刷新材质
          this.scheduleOnce(() => {
            for (var prefab of this._prefabArr) {
          ...
          var percentage = ((_crd && ggd === void 0 ? (_reportPossibleCrUseOfggd({
            error: Error()
        ...
        getStageTotal() {
          var all = this.stageConfigJson.json;
          var len = 0;
        ...
        initPrefabs() {
          ...
          for (var i = 0; i < total; i++) {
            var prefab = instantiate(this.SCPrefab);
            ...
            var btNode = prefab.getChildByName("btnBg");
            ...
            var detail = prefab.getChildByName("detail");
            (_crd && glf === void 0 ? (_reportPossibleCrUseOfglf({
              error: Error()
          ...
          ;
          var UIT = this.prefabPar.getComponent(UITransform);
          var toBottom = 200;
        ...
        */
        ...
        showStageDetail(e) {
          var prefab = e.target.parent;
          this.stageDetail.active = true;
          var stageNum = prefab.stageNum;
          var des = "";
        ...
        getStageDesByStageNum(stageNum) {
          var des = "";
          var stageData = this.stageConfigJson.json["stage" + stageNum];
          ...
          var strongList = this.stageStrongJson.json["stage" + stageNum];
        ...
        updatePrefabs() {
          var wp = this.prefabPar.parent.getWorldPosition();

          for (var i = 0; i < this._prefabArr.length; i++) {
            var prefab = this._prefabArr[i];
            var pwp = prefab.getWorldPosition();

            if (pwp.y - wp.y > this._initPos.changePos && prefab.stageNum + this._initPos.changeRank <= this._stageTotal) {
              //下移
              var offset = this._initPos.changeRank * this._initPos.gap;
              ...
              //上移
              var _offset = this._initPos.changeRank * this._initPos.gap;

              prefab.setWorldPosition(pwp.x, pwp.y - _offset, pwp.z);
              prefab.stageNum -= this._initPos.changeRank;
              prefab.getChildByName("Label").getComponent(Label).string = "第" + prefab.stageNum + "关";
            } //刷新材质
        ...
        onBtnEnter(e) {
          var p = e.target.parent.stageNum;
...
//# sourceMappingURL=8899cfbc76b55d2ec90ac2c0a33a86ce6b926741.js.map