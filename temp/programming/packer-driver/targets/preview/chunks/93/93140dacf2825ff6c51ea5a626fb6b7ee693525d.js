    ...
    execute: function () {
      ...
      _export("ThunderFissionBead", ThunderFissionBead = (_dec = ccclass('ThunderFissionBead'), _dec(_class = class ThunderFissionBead extends (_crd && Weapon === void 0 ? (_reportPossibleCrUseOfWeapon({
        ...
        changeFlyDir() {
          ...
          var radian = Math.sin(30 + Math.random() * 30); //反向向量
        ...
        createSplitTFB(dir) {
          var TFB = (_crd && plm === void 0 ? (_reportPossibleCrUseOfplm({
            error: Error()
...
//# sourceMappingURL=93140dacf2825ff6c51ea5a626fb6b7ee693525d.js.map