System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, QuadtreeRect, _crd;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "888bbjDMWZHcKwbmcRnFa25", "Quadtree", undefined);

      _export("default", QuadtreeRect = class QuadtreeRect {
        /**
        ...
        constructor(bounds, max_objects, max_levels, level) {
          if (max_objects === void 0) {
            max_objects = 10;
          }

          if (max_levels === void 0) {
            max_levels = 4;
          }
          ...
          this.nodes = [];
          this.max_objects = 5;
          this.max_levels = 10; // this.max_objects    = max_objects;
        ...
        getIndex(pRect) {
          ...
          var startIsNorth = pRect.y + rHh > horizontalMidpoint,
              ...
              endIsSouth = pRect.y - rHh < horizontalMidpoint; //top-right quad
...
//# sourceMappingURL=f95eb1b8f6ecf26509251b588da0d39d51ae3970.js.map