    ...
    execute: function () {
      ...
      _export("MergeEquLayer", MergeEquLayer = (_dec = ccclass('MergeEquLayer'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Node), _dec8 = property([SpriteFrame]), _dec(_class = (_class2 = class MergeEquLayer extends Component {
        ...
        updateEquList() {
          ...
          var _loop = function _loop() {
            ...
            if (data.type == "装备") {
              ...
              (_crd && glf === void 0 ? (_reportPossibleCrUseOfglf({
                error: Error()
              }), glf) : glf).createButton(_this.node, _prefab.getChildByName("itemBg"), "MergeEquLayer", "onBtnItemInMergeLayer", key);
            }
          };
        ...
        onBtnItemInMergeLayer(e, p) {
          ...
          var data2 = this.getMergeTargetData(data.name);
        ...
        onBtnMerge() {
          //判断材料是否足够
          var curTotal = this.getCurEquTotal(this.curSelect.data.name);
          var needTotal = this._mergeList[this.curSelect.data.lv];
        ...
        consumeEqu(curName, needTotal) {
          ...
          var lvArr = ["（一阶）", "（二阶）", "（三阶）", "（四阶）", "（五阶）", "（六阶）", "（七阶）", "（八阶）", "（九阶）"];

          for (var lv of lvArr) {
            var name = curName.slice(0, index) + lv;
        ...
        getMergeTargetData(curName) {
          ...
          var pre = list[curName.slice(0, 2)];
          if (!pre) throw "target is no existent";
          var targetName = pre + curName.slice(2);
...
//# sourceMappingURL=28d05f165a28dea5791ab5800a6a825c8ec1ed02.js.map