      ...
      _export("MakePillsLayer", MakePillsLayer = (_dec = ccclass('MakePillsLayer'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property([SpriteFrame]), _dec5 = property(Node), _dec6 = property(Material), _dec7 = property(Material), _dec8 = property(Node), _dec9 = property(Prefab), _dec(_class = (_class2 = class MakePillsLayer extends Component {
        ...
        initPillList() {
          this._pillListConfig.forEach((data, index) => {
            var pill = instantiate(this.pillPrefab); // let pill = plm.getFromPool("MPLPillPrefab");
        ...
        updatePillList() {
          for (var pill of this._pillPrefabArr) {
            var data = pill.data;
            var total = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
              error: Error()
            }), em) : em).dispatch("getItemTotalByIdOrName", data.name);
        ...
        initStoveBtn() {
          var btn = find("/stove", this.node); // btn.on("touchstart",this.onBtnMakePill,this);
        ...
        updateMaterialDemand() {
          ...
          var m1 = find("/stove/m1", this.node);
          var m2 = find("/stove/m2", this.node);
          var data1 = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
          }), em) : em).dispatch("getItemDataByIdOrName", this._curPillData.consumeItemName);
          var data2 = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
          }), em) : em).dispatch("getItemDataByIdOrName", "灵石");
          var t1 = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
          }), em) : em).dispatch("getItemTotalByIdOrName", this._curPillData.consumeItemName);
          var t2 = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
          }), em) : em).dispatch("getItemTotalByIdOrName", "灵石");
          var s1 = m1.getChildByName("sprite").getComponent(Sprite);
          var s2 = m2.getChildByName("sprite").getComponent(Sprite);
          (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
          ...
          var l1 = m1.getChildByName("Label").getComponent(Label);
          var l2 = m2.getChildByName("Label").getComponent(Label);
          var l12 = m1.getChildByName("Label2").getComponent(Label);
          var l22 = m2.getChildByName("Label2").getComponent(Label);
        ...
        onBtnMakePill() {
          ...
          var itemIsEnough = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
          }), em) : em).dispatch("itemIsEnough", this._curPillData.consumeItemName, this._curPillData.consumeTotal);
          var lingshiIsEnough = (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
        ...
        startMakePillsLayerGuide() {
          ...
          var tips = "获得物品一阶妖丹x10、灵石x50";
          (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
          }), em) : em).dispatch("tipsViewShow", tips);
          this.updateMaterialDemand();
          var guideTips = "点击丹炉，炼制丹药，提升修为。当材料不足时，材料图片会置灰。可以通过修炼场获取材料。";
          (_crd && em === void 0 ? (_reportPossibleCrUseOfem({
            error: Error()
...
//# sourceMappingURL=6087358b6630e485faf137312a67f31842d39acb.js.map